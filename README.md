...
* **Portfolio Website:** https://skgajawada.github.io
* **GitHub Repository:** https://github.com/skgajawada/skgajawada.github.io
...
* **JSON-Driven Core:** Total isolation between the display code and personal data profiles.
* **Dynamic Statistics:** Automatic run-time tracking and tallies of active certifications.
...
Data arrays load asynchronously when the application initializes. Modifying text parameters, expanding course histories, or adding new records only requires updating static array files without altering the core scripts.
...
Portfolio content is maintained inside external data files. The application reads these records asynchronously to build interactive layout views dynamically.
...
Because the application uses the Fetch API to load operational JSON data records asynchronously, modern browsers require local execution to occur over an active local web server. Direct file system launching (`file://`) may trigger CORS security restrictions.
...
Open the directory within Visual Studio Code and use the **Open with Live Server** option.
...
Portfolio content can be updated through the structured JSON files located under:

```text
assets/data/
```

* **`portfolio-data.json`** → Update biographies, standard metrics, technical skill blocks, and timeline entries.
* **`teaching-data.json`** → Reconfigure subjects, syllabus objects, student batches, and curriculum downloads.
* **`professional-development.json`** → Add or update professional development records and credential information.
* **`mooc-certifications.json`** → Add or update MOOC and certification records, platform information, verification links, and certificate documents.

---

## 🔒 Privacy & Data Policy

* **Telemetry Tracking:** The implementation does not execute analytical telemetry, deploy advertising pixels, or intentionally share user behavioral metrics.
* **Cookies Usage:** The platform functions without requiring persistent tracking configurations for its core operation.
* **Data Locality:** Graph evaluation, formatting, layout orchestration, and dashboard rendering are processed within the browser.
...
The layout architecture, underlying component injection framework, styling models, and custom routing scripts are available for open educational configuration and personal design reuse.

However, all academic records, specific text assessments, research files, publications, and associated structural credentials remain the exclusive intellectual property of the author and cannot be repurposed or republished without explicit written permission.
...
| 💼 **LinkedIn**          | https://linkedin.com/in/skgajawada                   |
| 🚀 **LeetCode**          | https://leetcode.com/u/skgajawada/                   |
| 🎓 **Google Scholar**    | https://scholar.google.com/citations?user=skgajawada |
| 📚 **ResearchGate**      | https://www.researchgate.org/profile/skgajawada      |
| 🆔 **ORCID**             | https://orcid.org/0000-0002-9171-5073                |
| 𝕏 **X (Twitter)**       | https://x.com/sk_gajawada                            |
| 🎬 **Vimeo**             | https://vimeo.com/skgajawada                         |
| 🦋 **Bluesky**           | https://bsky.app/profile/skgajawada.bsky.social      |
| 📸 **Instagram**         | https://www.instagram.com/skgajawada/                |
| 👥 **Facebook**          | https://www.facebook.com/skgajawada/                 |
| 🎥 **YouTube**           | https://www.youtube.com/@skgajawada                  |
| 💬 **WhatsApp**          | https://wa.me/skgajawada                             |
| ✈️ **Telegram**          | https://t.me/skgajawada                              |
...
* **The Open-Source Community** for developing high-performance frontend libraries such as Chart.js and Font Awesome.
* **Open-source contributors** whose libraries, tools, and utilities support the development and maintenance of this project.
